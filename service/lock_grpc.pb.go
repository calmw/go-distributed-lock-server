...
func (c *lockServiceClient) ForceLock(ctx context.Context, in *ForceLockRequest, opts ...grpc.CallOption) (*ForceLockReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ForceLockReply)
	err := c.cc.Invoke(ctx, LockService_ForceLock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLockServiceServer) ForceLock(context.Context, *ForceLockRequest) (*ForceLockReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ForceLock not implemented")
}
...
func _LockService_ForceLock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ForceLockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LockServiceServer).ForceLock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LockService_ForceLock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LockServiceServer).ForceLock(ctx, req.(*ForceLockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
